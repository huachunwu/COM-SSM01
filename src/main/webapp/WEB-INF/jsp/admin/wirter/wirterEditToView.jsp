...
<head>
    ...
    <link href="${pageContext.request.contextPath}/zui/lib/kindeditor/kindeditor.min.css" rel="stylesheet">
</head>
<body>
<form action="${pageContext.request.contextPath}/wirter/updateWirterById.cms" method="post" class="col-md-offset-2 col-md-8">
    <br/>
    <br/>
    <span class="label label-badge   label-success" style="font-size: 1.3em">文章修改</span>
    <br/>
    <br/>
    <div class="input-control has-label-left">
        <input id="wId" type="text" class="form-control" placeholder="" name="wId" value="${wirterById.wId}" readonly>
        <label for="wId" class="input-control-label-left">文章id:</label>
    </div>
    <div class="input-control has-label-left">
        <input id="sysUser.name" type="text" class="form-control" placeholder="" name="sysUser.name" value="${wirterById.sysUser.name}" readonly>
    ...
    <div class="input-control has-label-left">
        <select class="form-control" name="wSign" id="wSign">
            <c:if test="${wirterById.wSign=='0'}">
                <option value="0" selected>未发布</option>
                <option value="1">已发布</option>
            </c:if>
            <c:if test="${wirterById.wSign=='1'}">
